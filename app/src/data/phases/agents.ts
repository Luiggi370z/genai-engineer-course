  ...
  exercises: [
    ...
    },
    {
      ...
      solution: [
        ...
        "Measure durability, don't quote it. Read `resumable` back out of LangGraph's `get_state`; report `False` for the other two. That one row is what decides whether you need a database.",
